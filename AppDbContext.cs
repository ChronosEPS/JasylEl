...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TreeType>().HasData(
            new TreeType { Id = 1, Name = "Береза", Description = "Неприхотливое дерево для первых посадок.", Rarity = "Common", CostCoins = 30, CostWater = 15, CostEnergy = 5, UnlockLevel = 1, IsUnlockedByDefault = true, TimeToSapling = 2, TimeToSprout = 2, TimeToAdult = 2, GrowthTimeMultiplier = 1f, EcoPointsProduction = 1, WaterProduction = 1, TrunkColor = "#f4ead2", LeafColor = "#7bc96f", BaseWidth = 58, BaseHeight = 82 },
            new TreeType { Id = 2, Name = "Тополь", Description = "Быстро растёт и хорошо подходит для степи.", Rarity = "Common", CostCoins = 25, CostWater = 10, CostEnergy = 5, UnlockLevel = 1, IsUnlockedByDefault = true, TimeToSapling = 2, TimeToSprout = 2, TimeToAdult = 2, GrowthTimeMultiplier = 0.85f, EcoPointsProduction = 1, WaterProduction = 1, TrunkColor = "#9a7b55", LeafColor = "#2f8f46", BaseWidth = 48, BaseHeight = 100 },
            new TreeType { Id = 3, Name = "Осина", Description = "Лёгкое дерево с серебристой кроной.", Rarity = "Common", CostCoins = 35, CostWater = 20, CostEnergy = 8, UnlockLevel = 2, IsUnlockedByDefault = true, TimeToSapling = 2, TimeToSprout = 2, TimeToAdult = 2, GrowthTimeMultiplier = 1.05f, EcoPointsProduction = 2, WaterProduction = 1, TrunkColor = "#b8b8a8", LeafColor = "#a3c853", BaseWidth = 56, BaseHeight = 74 },
            new TreeType { Id = 4, Name = "Дуб", Description = "Редкое сильное дерево с большим вкладом в экологию.", Rarity = "Rare", CostCoins = 80, CostWater = 40, CostEnergy = 20, UnlockLevel = 4, TimeToSapling = 3, TimeToSprout = 3, TimeToAdult = 3, GrowthTimeMultiplier = 1.22f, EcoPointsProduction = 4, WaterProduction = 2, TrunkColor = "#5c4033", LeafColor = "#1f6f3a", BaseWidth = 96, BaseHeight = 104 },
            new TreeType { Id = 5, Name = "Кедр", Description = "Вечнозелёный редкий вид для сильной территории.", Rarity = "Rare", CostCoins = 100, CostWater = 50, CostEnergy = 25, UnlockLevel = 6, TimeToSapling = 3, TimeToSprout = 3, TimeToAdult = 3, GrowthTimeMultiplier = 1.14f, EcoPointsProduction = 5, WaterProduction = 3, TrunkColor = "#4a3728", LeafColor = "#2e8b57", BaseWidth = 80, BaseHeight = 125 },
            new TreeType { Id = 6, Name = "Липа", Description = "Полезное медоносное дерево для городских парков.", Rarity = "Rare", CostCoins = 75, CostWater = 35, CostEnergy = 18, UnlockLevel = 5, TimeToSapling = 3, TimeToSprout = 3, TimeToAdult = 3, GrowthTimeMultiplier = 0.95f, EcoPointsProduction = 3, WaterProduction = 2, TrunkColor = "#8b6914", LeafColor = "#86c95d", BaseWidth = 88, BaseHeight = 92 },
            new TreeType { Id = 7, Name = "Тянь-Шаньская ель", Description = "Эпическое горное дерево Казахстана.", Rarity = "Epic", CostCoins = 200, CostWater = 100, CostEnergy = 60, UnlockLevel = 10, TimeToSapling = 4, TimeToSprout = 4, TimeToAdult = 4, GrowthTimeMultiplier = 1.25f, EcoPointsProduction = 8, WaterProduction = 5, TrunkColor = "#3b2f2f", LeafColor = "#1a6b3a", BaseWidth = 100, BaseHeight = 155 },
            new TreeType { Id = 8, Name = "Арча", Description = "Эпический можжевельник горных склонов.", Rarity = "Epic", CostCoins = 180, CostWater = 80, CostEnergy = 50, UnlockLevel = 9, TimeToSapling = 4, TimeToSprout = 4, TimeToAdult = 4, GrowthTimeMultiplier = 1.08f, EcoPointsProduction = 7, WaterProduction = 4, TrunkColor = "#4b3832", LeafColor = "#355e3b", BaseWidth = 72, BaseHeight = 132 },
            new TreeType { Id = 9, Name = "Яблоня Сиверса", Description = "Легендарный предок культурных яблонь.", Rarity = "Legendary", CostCoins = 500, CostWater = 250, CostEnergy = 150, UnlockLevel = 15, TimeToSapling = 5, TimeToSprout = 5, TimeToAdult = 5, GrowthTimeMultiplier = 1.35f, EcoPointsProduction = 15, WaterProduction = 8, TrunkColor = "#6b3a2a", LeafColor = "#2f9d53", BaseWidth = 126, BaseHeight = 132 },
            new TreeType { Id = 10, Name = "Реликтовая ива", Description = "Легендарное дерево древних пойменных лесов.", Rarity = "Legendary", CostCoins = 600, CostWater = 300, CostEnergy = 180, UnlockLevel = 20, TimeToSapling = 5, TimeToSprout = 5, TimeToAdult = 5, GrowthTimeMultiplier = 1.2f, EcoPointsProduction = 20, WaterProduction = 12, TrunkColor = "#3d2b1f", LeafColor = "#78c850", BaseWidth = 160, BaseHeight = 122 }
        );
        ...
        modelBuilder.Entity<QuizQuestion>().HasData(
            ...
            Q(17, 2, 2, "Какое озеро Казахстана известно своей переменной солёностью?", "Балхаш", "Зайсан", "Маркаколь", "Алаколь", 0, "Балхаш уникален тем, что западная часть более пресная, а восточная солёная.", 22, 28, 12, 9, null),
            Q(18, 2, 2, "Почему вблизи озёр деревьям часто требуется меньше полива?", "Меньше ветра", "Больше влажность почвы и воздуха", "Потому что растут только хвойные", "Потому что меньше солнца", 1, "Озёра повышают локальную влажность и уменьшают дефицит воды.", 22, 30, 14, 9, null),
            Q(19, 3, 2, "Какой тип местности чаще даёт риск засухи?", "Песчаные и сухие зоны", "Лесные зоны", "Озёрные берега", "Городские парки", 0, "Песчаные и сухие зоны теряют влагу быстрее.", 24, 34, 10, 10, null),
            Q(20, 3, 3, "Какое действие лучше всего снижает риск засухи в регионе?", "Посадка рядом с водными зонами и устойчивых видов", "Только тратить энергию", "Игнорировать события", "Строить меньше складов воды", 0, "Связка выбора зоны и видов деревьев уменьшает вероятность засушливых эффектов.", 32, 46, 16, 12, null),
            Q(21, 1, 2, "Какой сорт из стартовых деревьев растёт быстрее остальных?", "Осина", "Берёза", "Тополь", "Дуб", 2, "В игровой модели тополь имеет ускоренный коэффициент роста.", 25, 32, 10, 10, 2),
            Q(22, 1, 3, "Какая цель зонирования карты в игре?", "Только изменить цвет фона", "Добавить ограничения и эффекты для геймплея", "Убрать регионы", "Сделать карту меньше", 1, "Зоны влияют на посадку, скорость роста, расход воды и события.", 34, 44, 14, 12, null),
            Q(23, 2, 3, "Почему посадка в городских границах запрещена по правилам MVP?", "Чтобы уменьшить размер карты", "Чтобы отделить природные и урбанизированные участки", "Чтобы убрать викторины", "Чтобы снизить награды", 1, "Города в MVP выделены как зоны без посадки для ясной логики игры.", 30, 42, 12, 11, null),
            Q(24, 4, 2, "Что лучше отражает связь механики игры с озёрами?", "Озёра только как декор", "Озёра влияют на рост и водный баланс", "Озёра отключают события", "Озёра повышают только опыт", 1, "Водные объекты должны влиять на рост, риск засух и расход воды.", 28, 38, 16, 11, null)
        );
    }

...
## MVP релиз 1 и этап 2

Релиз 1 (MVP) включает:
- зональную карту Казахстана (город, степь, сухие зоны, вода, плодородные зоны);
- серверный запрет посадки в городах и на водных объектах;
- проверку допустимости посадки перед действием на клиенте;
- обновлённые фазы роста с базой около 2 минут для обычных деревьев и модификаторами от сорта/региона/зоны;
- расширенную викторину (вопросы по регионам, озёрам, климату и типам местности).

Этап 2 (после MVP):
- более глубокая симуляция водного баланса озёр;
- расширенные цепочки природных эффектов и долгосрочные экологические сценарии.
